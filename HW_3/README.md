...
* **`01_TrainModel.ipynb`** (2 pts, Ex 2) — Clone pix2pixHD, apply Python-3.11+ patches, train 100 epochs with milestone checkpoints at 5/10/20/40/60/80/100 (extended from 40 after observing continued loss improvement)
